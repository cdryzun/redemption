...
template<> struct acl_and_spec_type<cfg::mod_rdp::tls_signature_algorithms> { using type = std::string; };
...
template<> struct acl_and_spec_type<cfg::mod_vnc::tls_signature_algorithms> { using type = std::string; };
...
template<> struct acl_and_spec_type<cfg::vnc_clipboard::enable_clipboard_upload> { using type = bool; };
template<> struct acl_and_spec_type<cfg::vnc_clipboard::enable_clipboard_download> { using type = bool; };
template<> struct acl_and_spec_type<cfg::vnc_clipboard::clipboard_encoding> { using type = std::string; };
template<> struct acl_and_spec_type<cfg::vnc_clipboard::bogus_infinite_loop_strategy> { using type = VncBogusClipboardInfiniteLoopStrategy; };
template<> struct acl_and_spec_type<cfg::vnc_file_transfer::enable_file_upload> { using type = bool; };
template<> struct acl_and_spec_type<cfg::vnc_file_transfer::enable_file_download> { using type = bool; };
template<> struct acl_and_spec_type<cfg::vnc_file_transfer::max_item_in_gui> { using type = uint32_t; };
template<> struct acl_and_spec_type<cfg::vnc_file_transfer::max_file_transfer_list> { using type = uint32_t; };
template<> struct acl_and_spec_type<cfg::vnc_file_transfer::max_file_size> { using type = uint64_t; };
