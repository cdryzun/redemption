...
'rdp': ({
    ...
    'rdp': {
        ...
        ('mod_rdp:tls_signature_algorithms', 'tls_signature_algorithms', "RSA+SHA256:RSA+SHA384:RSA+SHA512:RSA-PSS+SHA256:RSA-PSS+SHA384:RSA-PSS+SHA512:ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512"),
...
'vnc': ({
    ...
    'vnc': {
        ...
        ('mod_vnc:tls_min_level', 'tls_min_level', 2),
        ('mod_vnc:tls_max_level', 'tls_max_level', 0),
        ('mod_vnc:cipher_string', 'cipher_string', "ECDHE-ECDSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-GCM-SHA256:DHE-RSA-AES128-GCM-SHA256"),
        ('mod_vnc:tls_enable_legacy_server', 'tls_enable_legacy_server', False),
        ('mod_vnc:tls_1_3_ciphersuites', 'tls_1_3_ciphersuites', ""),
        ('mod_vnc:tls_key_exchange_groups', 'tls_key_exchange_groups', "P-256:P-384:P-521:ffdhe3072:ffdhe4096:ffdhe6144:ffdhe8192"),
        ('mod_vnc:tls_signature_algorithms', 'tls_signature_algorithms', ""),
