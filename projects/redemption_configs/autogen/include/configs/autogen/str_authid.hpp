...
namespace configs
{
    constexpr zstring_view const authstr[] = {
        ...
        "mod_rdp:tls_signature_algorithms"_zv,
        ...
        "mod_rdp:proxy_managed_drives"_zv,
        "mod_rdp:ignore_auth_channel"_zv,
        "alternate_shell"_zv,
        "shell_arguments"_zv,
        ...
        "mod_rdp:all_clients_use_translated_remoteapp"_zv,
        ...
        "server_cert:server_cert_check_using_ca"_zv,
        ...
        "mod_vnc:tls_min_level"_zv,
        "mod_vnc:tls_max_level"_zv,
        "mod_vnc:cipher_string"_zv,
        "mod_vnc:tls_enable_legacy_server"_zv,
        "mod_vnc:tls_1_3_ciphersuites"_zv,
        "mod_vnc:tls_key_exchange_groups"_zv,
        "mod_vnc:tls_signature_algorithms"_zv,
        "mod_vnc:show_common_cipher_list"_zv,
        "mod_vnc:force_authentication_method"_zv,
        "vnc_clipboard:clipboard_encoding"_zv,
        "vnc_clipboard:bogus_infinite_loop_strategy"_zv,
        "vnc_file_transfer:max_item_in_gui"_zv,
        "vnc_file_transfer:max_file_transfer_list"_zv,
        "vnc_file_transfer:max_file_size"_zv,
        "session_log:enable_session_log_file"_zv,
