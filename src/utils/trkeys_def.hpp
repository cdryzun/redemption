...
TR_KV(err_nla_required, "Enable NLA is probably required during TLS security exchange.")
TR_KV(err_tls_required, "Enable TLS is probably required during TLS security exchange.")
