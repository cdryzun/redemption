...
TR_KV(err_transport_tls_no_ca_certificate_available, "No CA certificate is available to verify server's certificate.")
...
TR_KV(err_transport_tls_certificate_not_trusted_extra_message, "The certificate presented by the target is not trusted by the Bastion. Contact your Bastion administrator to resolve this issue.")
TR_KV(err_transport_tls_no_ca_certificate_available_extra_message, "The certificate presented by the target cannot be verified because no CA certificate is available. Contact your Bastion administrator to add a CA certificate or to not require validation by a CA certificate.")
