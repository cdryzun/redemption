...
def process_migrate(migrate_def: MigrationDescType, ini: str) -> Tuple[bool, str]:
    r = migrate(parse_configuration(ini), migrate_def, is_bastion=False)
...
class TestMigration(unittest.TestCase):
    ...
    def test_migrate(self):
        ...
        migrate_def = {
            'sec1': {
                ...
                'removed_key': RemoveItem(ignored_when_bastion=True),
            },
        ...
        self.assertEqual(migrate(fragments, {}, is_bastion=False),
                         (False, fragments))

        self.assertEqual(migrate(fragments, {'video': {}}, is_bastion=False),
                         (False, fragments))

        self.assertEqual(migrate(fragments, migrate_def, is_bastion=False), (True, [
    ...
    def test_migrate_value_to_an_already_existing_value(self):
        ...
        self.assertEqual(migrate(fragments, {}, is_bastion=False), (False, fragments))
