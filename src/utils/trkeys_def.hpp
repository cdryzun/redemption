...
// certificate error, extra message (close box)
...
TR_KV(err_nla_required, "RDP negotiation phase failure during TLS security exchange: Enable NLA is probably required.")
TR_KV(err_tls_required, "RDP negotiation phase failure during TLS security exchange: Enable TLS is probably required.")
