...
namespace configs
{
    ...
    namespace cfg_indexes
    {
        ...
        inline constexpr int section2 = 17; /* client */
        ...
        inline constexpr int section10 = 139; /* vnc_clipboard */
        inline constexpr int section11 = 141; /* vnc_file_transfer */
        inline constexpr int section12 = 144; /* session_log */
        // inline constexpr int section13 = 146; /* ocr */
        inline constexpr int section14 = 146; /* capture */
        inline constexpr int section15 = 153; /* audit */
        inline constexpr int section16 = 162; /* file_verification */
        inline constexpr int section17 = 170; /* file_storage */
        // inline constexpr int section18 = 171; /* icap_server_down */
        // inline constexpr int section19 = 171; /* icap_server_up */
        inline constexpr int section20 = 171; /* crypto */
        // inline constexpr int section21 = 173; /* websocket */
        // inline constexpr int section22 = 173; /* vnc_over_ssh */
        inline constexpr int section23 = 173; /* context */
        // inline constexpr int section24 = 264; /* internal_mod */
        inline constexpr int section25 = 264; /* mod_replay */
        inline constexpr int section26 = 266; /* translation */
        // inline constexpr int section27 = 267; /* theme */
        // inline constexpr int section28 = 267; /* debug */
    } // namespace cfg_indexes
} // namespace configs
...
namespace cfg
{
    ...
    /// Specifies how long the RDP proxy login screen should be displayed before the client window closes. <br/>
    ...
    /// Reminders appear 30 minutes, 10 minutes, 5 minutes, and 1 minute before the session ends. <br/>
    /// type: bool <br/>
    ...
    /// Displays the target device name during the session when F12 is pressed. <br/>
    /// type: bool <br/>
    /// acl ⇒ proxy <br/>
    ...
    struct globals::enable_osd_display_remote_target {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section1 + 16};
        using type = bool;
        using mapped_type = bool;
        type value { true };
    };
    /// Displays the target username during the session when F12 is pressed. <br/>
    ...
    /// If true, ignore the password provided by the RDP client. The user must log in manually. <br/>
    /// type: bool <br/>
    /// default: false <br/>
    ...
    /// For details on the format, refer to this page: https://www.openssl.org/docs/man3.1/man1/openssl-ciphers.html#CIPHER-LIST-FORMAT <br/>
    /// This list is preconfigured based on the service's security profile and can be modified either by specifying custom algorithms or by adjusting the security profile. <br/>
    /// type: std::string <br/>
    ...
    /// Configure the available TLSv1.3 cipher suites. <br/>
    /// Empty to apply system-wide configuration. <br/>
    /// For details on the format, refer to the third paragraph on this page: https://www.openssl.org/docs/man1.1.1/man3/SSL_CTX_set_ciphersuites.html#DESCRIPTION <br/>
    /// This list is preconfigured based on the service's security profile and can be modified either by specifying custom algorithms or by adjusting the security profile. <br/>
    /// type: std::string <br/>
    ...
    /// Empty to apply system-wide configuration. <br/>
    /// For details on the format, refer to this page: https://www.openssl.org/docs/man3.2/man3/SSL_CONF_cmd.html#groups-groups <br/>
    /// This list is preconfigured based on the service's security profile and can be modified either by specifying custom algorithms or by adjusting the security profile. <br/>
    /// type: std::string <br/>
    ...
    /// Empty to apply system-wide configuration. <br/>
    /// The format should be a colon-separated list of signature algorithms, ordered by decreasing preference. Each entry should follow one of these forms: algorithm+hash or signature_scheme. <br/>
    /// algorithm options: RSA, RSA-PSS or ECDSA. <br/>
    /// hash options: SHA224, SHA256, SHA384 or SHA512. <br/>
    /// signature_scheme options: TLSv1.3 signature schemes (rfc8446#section-4.2.3) identified by their IETF names (e.g., ecdsa_secp384r1_sha384 or rsa_pss_rsae_sha256). <br/>
    ...
    /// Enables Kerberos authentication via NLA on RDP proxies (Primary authentication). <br/>
    /// ⚠ Kerberos authentication does not allow shortcuts to the target, the target selector will be displayed during connection. <br/>
    ...
    /// When enabled, ignores Ctrl+Alt+Del, Ctrl+Shift+Esc and Windows+Tab keyboard sequences. <br/>
    /// type: bool <br/>
    /// acl ⇒ proxy <br/>
    /// default: false <br/>
    ...
    /// When enabled, the content of Persistent Bitmap Caches are stored on the disk to reuse later (this value is ignored if [client]persistent_disk_bitmap_cache is disabled). <br/>
    /// type: bool <br/>
    /// default: false <br/>
    ...
    /// Enable RemoteFX on the client connection. Requires: <br/>
    /// - [client]max_color_depth set to 32 (32-bit RGB mask + alpha) <br/>
    ...
    /// ⚠ Only use this option if the target server or client is experiencing graphical issues. <br/>
    /// Disabling RDP orders generally reduces performance. <br/>
    ///  <br/>
    /// The following drawing orders can be disabled: <br/>
    ///    0: DstBlt <br/>
    ///    1: PatBlt <br/>
    ///    2: ScrBlt <br/>
    ///    3: MemBlt <br/>
    ...
    /// When enabled, the font smoothing desktop feature is automatically disabled in recorded session. <br/>
    ...
    /// Configure the supported client signature algorithms. <br/>
    /// Empty to apply system-wide configuration. <br/>
    /// The format should be a colon-separated list of signature algorithms, ordered by decreasing preference. Each entry should follow one of these forms: algorithm+hash or signature_scheme. <br/>
    /// algorithm options: RSA, RSA-PSS or ECDSA. <br/>
    /// hash options: SHA224, SHA256, SHA384 or SHA512. <br/>
    ...
    /// type: std::string <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: mod_rdp:tls_signature_algorithms <br/>
    /// displayName: TLS signature algorithms <br/>
    /// default: "RSA+SHA256:RSA+SHA384:RSA+SHA512:RSA-PSS+SHA256:RSA-PSS+SHA384:RSA-PSS+SHA512:ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512" <br/>
    struct mod_rdp::tls_signature_algorithms {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// When enabled, the content of Persistent Bitmap Caches are stored on disk for reusing them later (this value is ignored if [mod_rdp]persistent_disk_bitmap_cache is disabled). <br/>
    /// type: bool <br/>
    /// default: false <br/>
    ...
    /// Excludes certain types of events from the logs. For example, 'Preferred DropEffect' has no particular meaning. <br/>
    /// type: bool <br/>
    /// default: true <br/>
    ...
    /// When enabled, the RDP Proxy relies on the Session Probe to launch the remote programs. <br/>
    ...
    /// This parameter only has an effect on Desktop sessions. <br/>
    /// Choose between Smart launcher and Legacy launcher to launch the Session Probe. <br/>
    ...
    /// Enable or disable the Session Probe’s launch mask. <br/>
    ...
    /// Select how the system should behave if the Session Probe fails to launch. Recommended setting: Option 1 (Disconnect user). <br/>
    ...
    /// When enabled, a special mechanism prevents the launch sequence from starting until the user has logged into Windows. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: session_probe:ensure_launch_sequence_only_starts_after_logon <br/>
    /// default: false <br/>
    struct session_probe::ensure_launch_sequence_only_starts_after_logon {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// When enabled, the [session_probe]launch_timeout countdown begins only after the user logs into Windows. When disabled, the countdown starts immediately upon RDP connection. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// Specifies how long the RDP Proxy waits for a reply to the KeepAlive message from the Session Probe before applying the behavior defined by [session_probe]on_keepalive_timeout. <br/>
    /// If the local network experiences congestion or Windows responsiveness is slow, increasing this timeout can help reduce disruptions caused by [session_probe]on_keepalive_timeout. <br/>
    /// The KeepAlive message is used to detect Session Probe unavailability. Without Session Probe, session monitoring is minimal. No metadata is collected. <br/>
    ...
    /// Select how the RDP Proxy should behave if the connection to Session Probe is lost. Recommended setting: Option 2 (Freeze connection and wait). <br/>
    ...
    /// When enabled, Session Probe will automatically end the disconnected Desktop session. Otherwise, the RDP session and the applications it contains will remain active after user disconnection (unless a parameter defined at the RDS-level decides otherwise). <br/>
    ...
    /// When enabled, disconnected auto-deployed Application Driver sessions are automatically terminated by Session Probe. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// Enable or disable the Windows-side logging of Session Probe. <br/>
    ...
    /// Enable or disable log file rotation for Windows-side logging of Session Probe. <br/>
    /// Log rotation helps limit disk space usage but may cause loss of important information if log files are not retrieved before rotation occurs. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// (Deprecated!) <br/>
    /// Delay before the Session Probe automatically closes a disconnected Application session. <br/>
    /// 0 to disable timeout. <br/>
    /// type: std::chrono::milliseconds <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// (Deprecated!) <br/>
    /// Delay before the Session Probe automatically closes a disconnected Desktop session. <br/>
    /// 0 to disable timeout. <br/>
    /// type: std::chrono::milliseconds <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// Delay before the Session Probe locks the session due to user inactivity. <br/>
    /// 0 to disable timeout. <br/>
    /// type: std::chrono::milliseconds <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// Delay between two simulated keystrokes during the Session Probe launch sequence execution. <br/>
    /// This parameter is effective only if [session_probe]use_smart_launcher is enabled. <br/>
    ...
    /// Delay between two steps of the same simulated keystrokes during the Session Probe launch sequence execution. <br/>
    /// This parameter is effective only if [session_probe]use_smart_launcher is enabled. <br/>
    /// This parameter may help if the Session Probe launch failure is caused by network slowness or device under-performance. <br/>
    ...
    /// Delay between the detection of an error (example: a refusal by the target of the redirected drive) and the actual abandonment of the Session Probe launch. <br/>
    ...
    /// Enable or disable the crash dump generation when the Session Probe encounters a fatal error. <br/>
    ...
    /// Use only if there is unusually high consumption of system object handles by Session Probe. <br/>
    /// The Session Probe will sabotage and then restart itself if it consumes more handles than what is defined by this parameter. <br/>
    ...
    /// Use only if there is unusually high consumption of memory by Session Probe. <br/>
    /// The Session Probe will sabotage and then restart itself if it consumes more memory than what is defined by this parameter. <br/>
    /// A value of 0 disables this feature. <br/>
    /// This feature can cause the session to be disconnected if the value of the [session_probe]on_keepalive_timeout is set to 1 (Disconnect user). <br/>
    /// If [session_probe]allow_multiple_handshake is disabled, restarting the Session Probe will cause the session to disconnect. <br/>
    /// type: uint32_t <br/>
    ...
    /// Delay between the launch of the application and the start of End of session check. <br/>
    ...
    /// For application session only. <br/>
    /// When enabled, during the End of session check, the processes that do not have a visible window will not be counted as active processes of the session. Without active processes, the application session will be logged off by the Session Probe. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    ...
    /// Provides the list of (comma-separated) system processes that can be run in the session. <br/>
    ...
    /// Unfortunately, the detection does not work with applications developed in Java, Flash, etc. In order to work around the problem, the windows of these applications will be treated as input fields of unknown type. Therefore, the text entered in these will not be included in the session’s metadata. <br/>
    ...
    /// This parameter concerns the functionality of the Password field detection performed by the Session Probe. This detection is necessary to avoid logging the text entered in the password fields as metadata of session (also known as Session log). <br/>
    /// Unfortunately, the detection is not infallible. In order to work around the problem, the windows of these applications will be treated as input fields of unknown type. Therefore, the text entered in these will not be included in the session’s metadata. <br/>
    ...
    /// When enabled, the Session Probe will activate or deactivate features according to the value of [session_probe]disabled_features received when resuming its host session. Otherwise, the Session Probe will keep the same set of features that were used during the previous connection. <br/>
    ...
    /// Select the behavior of the RDP Proxy in case of detection of Windows account manipulation. <br/>
    ...
    /// Indicate the name of an environment variable, to be set on the Windows device, and pointed to a directory (on the device) that can be used to store and start the Session Probe. The environment variable must be available in the Windows user session. <br/>
    ...
    /// When enabled, a disconnected session can be resumed by a different Bastion user. <br/>
    ...
    /// List of (comma-separated) rules used to monitor outgoing connections created in the session. <br/>
    ...
    /// List of (comma-separated) rules used to monitor the execution of processes in the session. <br/>
    ...
    /// When enabled, a string of random characters will be added to the name of the Session Probe executable. <br/>
    ...
    /// When enabled, the RDP Proxy accepts to perform the handshake several times during the same RDP session. Otherwise, any new handshake attempt will interrupt the current session with the display of an alert message. <br/>
    /// type: bool <br/>
    ...
    /// When disabled, the RDP proxy disconnects from the session when Session Probe reports that the session is about to close (old behavior). <br/>
    ...
    /// Delay between two polling performed by Session Probe. <br/>
    ...
    /// When enabled, Session Probe activity will be minimized when the user is disconnected from the session. No metadata will be collected during this time. <br/>
    ...
    /// When enabled, Session Probe monitors its own system resource consumption. <br/>
    ...
    struct session_probe::monitor_own_resources_consumption {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section7 + 45};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    /// Configure server certificate verification behavior. <br/>
    ...
    /// type: std::string <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: mod_vnc:tls_signature_algorithms <br/>
    /// displayName: TLS signature algorithms <br/>
    /// default: "" <br/>
    struct mod_vnc::tls_signature_algorithms {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// When specified, forces the proxy to use a specific authentication method. If this method is not supported by the target server, the connection will not be made. <br/>
    ///   - noauth <br/>
    ///   - vncauth <br/>
    ///   - mslogon <br/>
    ///   - mslogoniiauth <br/>
    ...
    /// Enable the clipboard upload (from client to target server). <br/>
    /// This only supports text data clipboard, not files. <br/>
    /// type: bool <br/>
    /// default: false <br/>
    struct vnc_clipboard::enable_clipboard_upload {
        static constexpr unsigned acl_proxy_communication_flags = 0b00;
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    /// Enable the clipboard download (from target server to client). <br/>
    /// This only supports text data clipboard, not files. <br/>
    /// type: bool <br/>
    /// default: false <br/>
    struct vnc_clipboard::enable_clipboard_download {
        static constexpr unsigned acl_proxy_communication_flags = 0b00;
        using type = bool;
        using mapped_type = bool;
        type value { false };
    ...
    /// type: VncClipboardEncoding <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: vnc_clipboard:clipboard_encoding <br/>
    /// default: VncClipboardEncoding::latin1 <br/>
    struct vnc_clipboard::clipboard_encoding {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section10 + 0};
        using type = VncClipboardEncoding;
        using mapped_type = std::string;
        type value { VncClipboardEncoding::latin1 };
    };
    ...
    /// type: VncBogusClipboardInfiniteLoopStrategy <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: vnc_clipboard:bogus_infinite_loop_strategy <br/>
    /// default: VncBogusClipboardInfiniteLoopStrategy::delayed <br/>
    struct vnc_clipboard::bogus_infinite_loop_strategy {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section10 + 1};
        using type = VncBogusClipboardInfiniteLoopStrategy;
        using mapped_type = VncBogusClipboardInfiniteLoopStrategy;
        type value { VncBogusClipboardInfiniteLoopStrategy::delayed };
    };

    /// Enable the file transfer upload (from client to target server). <br/>
    /// This feature is only supported by Ultra VNC server. <br/>
    /// type: bool <br/>
    /// default: false <br/>
    struct vnc_file_transfer::enable_file_upload {
        static constexpr unsigned acl_proxy_communication_flags = 0b00;
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    /// Enable the file transfer download (from target server to client). <br/>
    /// This feature is only supported by Ultra VNC server. <br/>
    /// type: bool <br/>
    /// default: false <br/>
    struct vnc_file_transfer::enable_file_download {
        static constexpr unsigned acl_proxy_communication_flags = 0b00;
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    /// Maximum item in folder showed by the GUI. <br/>
    /// type: uint32_t <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: vnc_file_transfer:max_item_in_gui <br/>
    /// displayName: Max item in GUI <br/>
    /// default: 100000 <br/>
    struct vnc_file_transfer::max_item_in_gui {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// Maximum file number authorized for one upload or download. <br/>
    /// type: uint32_t <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: vnc_file_transfer:max_file_transfer_list <br/>
    /// default: 10000 <br/>
    struct vnc_file_transfer::max_file_transfer_list {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// Maximum file size authorized for an upload or a download. <br/>
    /// type: uint64_t <br/>
    /// connpolicy -> proxy <br/>
    /// aclName: vnc_file_transfer:max_file_size <br/>
    /// default: 268435456 <br/>
    struct vnc_file_transfer::max_file_size {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
    ...
    /// Determines how keyboard input is logged. Session Probe is required for input identification and masking. <br/>
    ...
    ///   0   - all of characters must be recognized <br/>
    ...
    /// FFmpeg options for video codec. For details, visit https://trac.ffmpeg.org/wiki/Encode/H.264 <br/>
    ...
    struct audit::redis_tls_key {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section15 + 8};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct file_verification::enable_down {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 1};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct file_verification::clipboard_text_up {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 2};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct file_verification::clipboard_text_down {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 3};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct file_verification::block_invalid_file_up {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 4};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct file_verification::block_invalid_file_down {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 5};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    /// Log the files and clipboard texts that are verified and accepted. If deactivated, only those rejected are logged. <br/>
    /// type: bool <br/>
    /// connpolicy -> proxy <br/>
    ...
    struct file_verification::log_if_accepted {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 6};
        using type = bool;
        using mapped_type = bool;
        type value { true };
    };
    ...
    struct file_verification::max_file_size_rejected {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section16 + 7};
        using type = uint32_t;
        using mapped_type = uint32_t;
        type value { 256 };
    };
    ...
    struct context::password {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 18};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::reporting {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 19};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_channel_answer {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 20};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_channel_target {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 21};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 22};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::display_link {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 23};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::mod_timeout {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 24};
        using type = std::chrono::seconds;
        using mapped_type = std::chrono::seconds;
        type value { 0 };
    };
    ...
    struct context::accept_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 25};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::display_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 26};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::rejected {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 27};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::keepalive {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 28};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::session_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 29};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::end_date_cnx {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 30};
        using type = std::chrono::seconds;
        using mapped_type = std::chrono::seconds;
        type value { 0 };
    };
    ...
    struct context::real_target_device {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 31};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::authentication_challenge {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 32};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::ticket {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 33};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::comment {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 34};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::duration {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 35};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::duration_max {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 36};
    ...
    struct context::waitinforeturn {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 37};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::formflag {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 38};
        using type = unsigned;
        using mapped_type = unsigned;
        type value { 0 };
    };
    ...
    struct context::module {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 39};
    ...
    struct context::try_alternate_target {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 40};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::has_more_target {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 41};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    /// Not used when [globals]enable_wab_integration is off. <br/>
    /// type: std::string <br/>
    /// acl ⇒ proxy <br/>
    /// default: "" <br/>
    struct context::proxy_opt {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 42};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::pattern_kill {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 43};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::pattern_notify {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 44};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::opt_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 45};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::login_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 46};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::disconnect_reason {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 47};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::disconnect_reason_ack {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 48};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::recording_started {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 49};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::rt_ready {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 50};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::sharing_ready {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 51};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::auth_command {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 52};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_notify {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 53};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_notify_rail_exec_flags {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 54};
        using type = unsigned;
        using mapped_type = unsigned;
        type value { 0 };
    };
    ...
    struct context::auth_notify_rail_exec_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 55};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_exec_result {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 56};
        using type = uint16_t;
        using mapped_type = uint16_t;
        type value { 0 };
    };
    ...
    struct context::auth_command_rail_exec_flags {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 57};
        using type = uint16_t;
        using mapped_type = uint16_t;
        type value { 0 };
    };
    ...
    struct context::auth_command_rail_exec_original_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 58};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_exe_or_file {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 59};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_working_dir {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 60};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_arguments {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 61};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_account {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 62};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::auth_command_rail_exec_password {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 63};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::is_wabam {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 64};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::pm_response {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 65};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::pm_request {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 66};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::native_session_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 67};
        using type = uint32_t;
        using mapped_type = uint32_t;
        type value { 0 };
    };
    ...
    struct context::rd_shadow_available {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 68};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::rd_shadow_userdata {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 69};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::rd_shadow_type {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 70};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::rd_shadow_invitation_error_code {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 71};
        using type = uint32_t;
        using mapped_type = uint32_t;
        type value { 0 };
    };
    ...
    struct context::rd_shadow_invitation_error_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 72};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::rd_shadow_invitation_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 73};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::rd_shadow_invitation_addr {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 74};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::rd_shadow_invitation_port {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 75};
        using type = uint16_t;
        using mapped_type = uint16_t;
        type value { 0 };
    };
    ...
    struct context::session_sharing_userdata {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 76};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_enable_control {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 77};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::session_sharing_ttl {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 78};
        using type = std::chrono::seconds;
        using mapped_type = std::chrono::seconds;
        type value { 600 };
    };
    ...
    /// acl ⇒ proxy <br/>
    /// default: "" <br/>
    struct context::session_sharing_interface {
        static constexpr unsigned acl_proxy_communication_flags = 0b10;
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 79};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_invitation_error_code {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 80};
        using type = uint32_t;
        using mapped_type = uint32_t;
        type value { 0 };
    };
    ...
    struct context::session_sharing_invitation_error_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 81};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_invitation_id {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 82};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_invitation_addr {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 83};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_target_ip {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 84};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::session_sharing_target_login {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 85};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::smartcard_login {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 86};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::banner_message {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 87};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct context::banner_type {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 88};
    ...
    struct context::authenticated_by_nla {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 89};
        using type = bool;
        using mapped_type = bool;
        type value { false };
    };
    ...
    struct context::ca_certificates {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section23 + 90};
        using type = std::string;
        using mapped_type = std::string;
        type value {  };
    };
    ...
    struct translation::language {
        ...
        // for old cppcheck
        // cppcheck-suppress obsoleteFunctionsindex
        static constexpr ::configs::authid_t index { ::configs::cfg_indexes::section26 + 0};
        using type = Language;
        using mapped_type = std::string;
        type value { Language::en };
    };
    /// The login page displays this language for all users. After logging in, users experience the interface in their selected language. <br/>
    ...
    /// For details, visit https://www.ffmpeg.org/doxygen/2.3/group__lavu__log__constants.html <br/>
    /// type: uint32_t <br/>
...
, cfg::mod_rdp::tls_signature_algorithms
...
, cfg::session_probe::ensure_launch_sequence_only_starts_after_logon
...
, cfg::mod_vnc::tls_signature_algorithms
...
: cfg::vnc_clipboard::enable_clipboard_upload
, cfg::vnc_clipboard::enable_clipboard_download
, cfg::vnc_clipboard::clipboard_encoding
, cfg::vnc_clipboard::bogus_infinite_loop_strategy
{ static constexpr bool is_section = true; };

struct vnc_file_transfer
: cfg::vnc_file_transfer::enable_file_upload
, cfg::vnc_file_transfer::enable_file_download
, cfg::vnc_file_transfer::max_item_in_gui
, cfg::vnc_file_transfer::max_file_transfer_list
, cfg::vnc_file_transfer::max_file_size
{ static constexpr bool is_section = true; };
...
, cfg::context::session_sharing_interface
...
, cfg_section::mod_vnc
, cfg_section::vnc_clipboard
, cfg_section::vnc_file_transfer
...
, 0b0111111011111111111001111111111111101111111111111111111111111111
, 0b0111111111111111111011111111111111111111111111111111111111111101
