...
inline FileValidatorId send_open_data(
    OutTransport trans, FileValidatorId file_id, chars_view target_name,
...
struct FileValidatorService
{
    ...
    FileValidatorId open_file(chars_view filename, chars_view target_name)
    {
    ...
    FileValidatorId open_text(uint32_t locale_identifier, chars_view target_name)
    {
    ...
    FileValidatorId open_unicode(chars_view target_name)
    {
...
private:
    ...
    FileValidatorId open_raw_data(chars_view target_name, DataMap data_map)
    {
