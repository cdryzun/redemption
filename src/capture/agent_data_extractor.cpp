...
bool AgentDataExtractor::is_relevant_log_id(LogId id) noexcept
{
    ...
    switch (id) {
        ...
        case LogId::SESSION_INVITE_GUEST_CONNECTION:
        case LogId::SESSION_INVITE_GUEST_CONNECTION_REJECTED:
        case LogId::SESSION_INVITE_GUEST_DISCONNECTION:
        case LogId::SESSION_INVITE_CONTROL_OWNERSHIP_CHANGED:
        case LogId::SESSION_INVITE_GUEST_KILLED:
